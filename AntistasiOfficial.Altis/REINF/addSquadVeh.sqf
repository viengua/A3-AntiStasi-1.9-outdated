...
if ((not(_typeX in guer_vehicleArray)) and (not(_typeX in var_AAF_groundForces)) and (not(_typeX in CIV_vehicles))) exitWith {hint "You are not looking to a valid vehicle"};

...
Description:
	Funci�n que busca vehiclesX cercanos y hace entrar a las unidades del lider
Parameter(s):
	<--- leader
	<--- Vehicle types
	<--- Searching radius
...
****************************************************************/
private["_npc","_vehtypes","_distance","_types","_marker","_closeX","_emptypositions","_vehicles","_Cargocount","_Gunnercount","_Commandercount","_Drivercount","_isuav","_inzone"];	
...
_closeX = _npc nearentities [["CAR","TANK","SHIP","HELICOPTER"], _distance];

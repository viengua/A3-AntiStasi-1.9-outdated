...
outposts = ["puesto_1","puesto_2","puesto_3"]; // outposts
outpostsAA = ["puestoAA_1","puestoAA_2","puestoAA_3"]; // AA outposts
seaports = ["puerto_1","puerto_2","puerto_3","puerto_4","puerto_5","puerto_6"]; // harbours

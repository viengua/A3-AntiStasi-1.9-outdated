...
_aaf = [((mrkAAF-citiesX)-colinasAA)-controlsX, _r, 1] call ws_fnc_markersToGridArray;
...
[((mrkAAF-citiesX)-colinasAA)-controlsX, _r, 1, _sum] call ws_fnc_markersToGridArray;

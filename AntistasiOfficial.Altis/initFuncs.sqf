...
actionArsenal = compile preProcessFileLineNumbers "Municion\actionArsenal.sqf";
...
emptyX = compile preProcessFileLineNumbers "Municion\emptyX.sqf";
...
boxAAF = compile preProcessFileLineNumbers "Municion\boxAAF.sqf";
